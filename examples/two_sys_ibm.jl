...
# IBM Guadelope (q=0,1)
f01 = [5.113535725239690, 5.160748676896810] 

nSys = length(Ne)
# xi = -0.34 * ones(Int64, nSys)
xi = [-0.33523244411102300, -0.31826942892534200]
...
init_amp_frac = 0.4 # Fraction of max ctrl amplitude for initial random guess
rand_seed = 2345
