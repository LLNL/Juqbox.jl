...
constraintType = 0 # 1 # 2 # 0: Augmented Lagrange method, no explicit constraints, 1: unitary constraints on initial conditions and norm^2(jump), 2: zero norm^2(jump) to make the state continuous across time intervals, 4: U(T_j) - W_j = 0 (pointwise).
# Set to 1 when using fidType = 2

nTimeIntervals = 4 # 100 # 10 # 5 # 1 # 4 #  3 # 25 # 3 # 4 # 3 # 3 # 2 # 1
